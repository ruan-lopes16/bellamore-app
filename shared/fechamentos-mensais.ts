 ...
 * ao vivo em `porMes`.
 *
 * Sem isso, Relatorios e Dashboard (web e mobile) mostram receita zerada em
 * meses cobertos so por importacao (sem agendamento/venda por tras), enquanto as
 * despesas desses meses continuam contando — distorcendo o "Lucro real".
 */
