-- ============================================================
-- MIGRATION 032 — Corrige role do owner em empresa_membros
--
-- Problema 1: criar_empresa_completo usava role='gestor' para o owner.
-- Problema 2: owners com role errado no banco ficavam invisíveis ou
--             exibidos com badge "Gestor" em vez de "Dono(a)".
--
-- Fix:
--   1. Atualiza a função para inserir role='owner'
--   2. Corrige registros existentes: se o user_id é owner da empresa
--      mas role está como 'gestor' ou 'profissional', corrige para 'owner'
-- ============================================================

-- 1. Corrige a função de criação de empresa
...
-- 2. Corrige registros existentes onde o owner_id da empresa não tem role='owner'
