  ...
  return (
    <div className="bm-modal fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-surface rounded-2xl shadow-xl w-full max-w-md flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={salvar} className="p-5 flex flex-col gap-4 flex-1 overflow-y-auto">
          <div>
...
function VenderModal({
  ...
  return (
    <div className="bm-modal fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={onClose}/>
      <div className="relative bg-surface rounded-2xl shadow-xl w-full max-w-sm flex flex-col max-h-[90vh] overflow-y-auto">
